...
INSERT INTO jogo(titulo, descricao, capa_url, desenvolvedor, genero, data_lanc, class_indicativa) 
VALUES("Red Dead Redemption", "", "https://upload.wikimedia.org/wikipedia/pt/f/f3/Red_Dead_Redemption_capa.png", "Rockstar Games", "Mundo Aberto", "2010-05-18", "18");

DROP TABLE IF EXISTS jogo_loja;
CREATE TABLE IF NOT EXISTS jogo_loja(
    id INT UNSIGNED PRIMARY KEY AUTO_INCREMENT,
    preco DECIMAL(6, 2) DEFAULT 0.00,
    preco_promocao DECIMAL(6, 2) NULL,
    data_promocao_inicio DATETIME NULL,
    data_promocao_fim DATETIME NULL,
    avaliacao DECIMAL(3,1),
    avaliacao_max DECIMAL(3,1),
